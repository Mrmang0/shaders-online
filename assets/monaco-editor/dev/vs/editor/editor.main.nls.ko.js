...
define("vs/editor/editor.main.nls.ko", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"인레이 힌트는 사용할 수 없음",
		"편집기에서 인레이 힌트의 글꼴 크기를 제어합니다. 기본적으로 `#editor.fontSize#`은(는) 구성된 값이 \'5\'보다 작거나 편집기 글꼴 크기보다 클 때 사용됩니다.",
		...
		"브래킷 쌍 색상화가 활성화되었는지 여부를 제어합니다. 브래킷 하이라이트 색상을 재정의하려면 `#workbench.colorCustomizations#`를 사용하세요.",
