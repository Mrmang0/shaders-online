...
export class FindModelBoundToEditorModel {
    ...
    _largeReplaceAll() {
        const searchParams = new SearchParams(this._state.searchString, this._state.isRegex, this._state.matchCase, this._state.wholeWord ? this._editor.getOption(117 /* EditorOption.wordSeparators */) : null);
