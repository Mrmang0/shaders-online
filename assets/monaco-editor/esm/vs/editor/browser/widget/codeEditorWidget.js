...
let CodeEditorWidget = class CodeEditorWidget extends Disposable {
    ...
    getConfiguredWordAtPosition(position) {
        ...
        return WordOperations.getWordAtPosition(this._modelData.model, this._configuration.options.get(117 /* EditorOption.wordSeparators */), position);
    }
    ...
    applyFontInfo(target) {
        applyFontInfo(target, this._configuration.options.get(44 /* EditorOption.fontInfo */));
    }
