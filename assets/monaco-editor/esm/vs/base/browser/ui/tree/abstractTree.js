...
class TypeFilterController {
    ...
    onEventOrInput(e) {
        ...
        else if (e instanceof MouseEvent || e.keyCode === 9 /* KeyCode.Escape */ || (e.keyCode === 1 /* KeyCode.Backspace */ && (isMacintosh ? e.altKey : e.ctrlKey))) {
            this.onInput('');
        }
