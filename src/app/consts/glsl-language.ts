...
export async function registerGlslLanguage() {
    await monaco.languages.register({
        id: "glsl",
    ...
    await monaco.languages.setMonarchTokensProvider("glsl", language);
    await monaco.languages.setLanguageConfiguration("glsl", conf);
    registerComplitions();
}

function registerComplitions() {

    const completionItemProvider = (monaco: any) => {
    ...
    monaco.languages.registerCompletionItemProvider("glsl", completionItemProvider(monaco))
